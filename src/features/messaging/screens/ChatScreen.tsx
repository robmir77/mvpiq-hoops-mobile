...
export default function ChatScreen() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const otherParticipantId = currentConversation.participant1Id === currentConversation.participant1?.id 
  ...
  const isMyMessage = (message: Message) => {
    ...
    return message.senderId === currentConversation?.participant1Id
  }
    ...
    return (
      <View key={message.id} style={[
        ...
        <View style={[
          ...
          isMyMsg ? styles.myBubble : styles.otherBubble
        ]}>
          <Text style={[
            styles.messageText,
  ...
  const getParticipantName = () => {
    const participant = currentConversation.participant1 || currentConversation.participant2
    return participant?.displayName || participant?.username || 'Sconosciuto'
  }
